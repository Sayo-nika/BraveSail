...
label ca5:
    ...
    s "Do you want some tea, my fellow friends?"
    ...
    sm "AAAAH! Frenchman!" # WRONG Sayonika!
    mc "Frenchman?"
    mc "Don’t you mean englishman?"
    sm "Aren’t they the same?" # Wrong!
    ...
    s "Okay, sorry...I'll do it this time!"
    ...
    "This is not fine."
    mc "Totally...fine..."
    s "L-L-Let me go get you a tissue!!"
    sm "You look like you're in a lot of pain, [player]...do you need to go to the hospital...?"
    "My voice starts squeaking up."
    mc "Totally fineee!"
    sm "I'm not convinced! Convince me!!"
    ...
    s "I'm back with an ice pack, [player], sit down please..."
    ...
    s "H-How does it feel...? Are you any better...?"
    ...
    s "!"
    sm "Ehehe...umm, Natsuki told us, by the way..."
    s "Uwaaaa! Why doesn't anyone trust me?!"
