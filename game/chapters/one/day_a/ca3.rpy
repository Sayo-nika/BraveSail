label ca3:
    ...
    sm 1b "See, [player]? This is why I brought you here~"
    show sayonika at t22
    ...
    show natsuki at t21
    show sayonika at f22
    sm 1l "Say it! Tell me that your food is the best, that it’s one of a kind!"
    show sayonika at t22
    show natsuki at f21
    n "Okay, okay! Jeez..."
    ...
    show natsuki at t21
    show sayonika at f22
    sm 1y "I can't believe we've been lied to!"
    show sayonika at t22
    ...
    show natsuki at t21
    show sayonika at f22
    sm 1z "I don't like her much too...she's so...depressing!"
    show sayonika at t22
    ...
    show sayonika at f22
    sm 1b "It's OK, [player]! I know where the rest of the gang is!"
    show sayonika at t22
    ...
    mc "Hey, let go!!"
    sm 1l "Oops! Sorry, ehehe..."
    mc "Where are you taking me?"
    sm 2a "Someone who's on the {i}cutting edge{/i} of technology."
    "I suddenly realise what she means."
    mc "Oh, come on!! Seriously?!"
    sm 1m "Whaat? It was a good joke!"
